...
import com.byhealth.wechat.mysdk.api.MenuClient;
import com.byhealth.wechat.mysdk.beans.menu.ClickButton;
import com.byhealth.wechat.mysdk.beans.menu.ComplexButton;
import com.byhealth.wechat.mysdk.beans.menu.Menu;
import com.byhealth.wechat.mysdk.beans.menu.ViewButton;
import com.byhealth.wechat.mysdk.constants.WechatMenuConstants;
...
public class WechatMenuServiceImpl extends BaseAbstractService<WechatMenuEntity> implements WechatMenuService {
	 ...
	 * 保存菜单
	 * (non-Javadoc)
	 * @see com.byhealth.wechat.base.web.admin.service.WechatMenuService#saveMenu(com.byhealth.wechat.base.web.admin.entity.WechatMenuEntity, java.lang.String)
	 */
	@Override
	 ...
	 * 更新菜单
	 * (non-Javadoc)
	 * @see com.byhealth.wechat.base.web.admin.service.WechatMenuService#updateMenu(com.byhealth.wechat.base.web.admin.entity.WechatMenuEntity, java.lang.String)
	 */
	@Override
...
//			sql.append(" where m.sysUser.id = ? and m.menu_key = a.key_word and a.extApp.id = e.id and a.material.id = ma.id");
	 ...
	 * 菜单发布
	 * (non-Javadoc)
	 * @see com.byhealth.wechat.base.web.admin.service.WechatMenuService#release(com.byhealth.wechat.base.web.admin.entity.SysUser)
	 */
	@Override
